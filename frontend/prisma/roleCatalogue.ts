...
export const ALL_PERMISSIONS: Permission[] = [
  ...
  { id: "vm.config", name: "vm.config", category: "vm", description: "Modify VM configuration (excludes explicit tenant MAC and VLAN rights)", isDangerous: true },
  ...
  { id: "vm.config.nic", name: "vm.config.nic", category: "vm", description: "Add, remove and edit NICs (excludes explicit tenant MAC and VLAN rights)" },
  { id: "vm.config.nic.mac", name: "vm.config.nic.mac", category: "vm", description: "Explicitly allow tenant NIC MAC address changes", isDangerous: true },
  { id: "vm.config.nic.vlan", name: "vm.config.nic.vlan", category: "vm", description: "Explicitly allow tenant NIC VLAN tag and trunk changes", isDangerous: true },
