var XtermLib = (() => {
  ...
  // ../../../../frontend/node_modules/xterm/lib/xterm.js
  var require_xterm = __commonJS({
    "../../../../frontend/node_modules/xterm/lib/xterm.js"(exports, module) {
      !(function(e, t) {
        ...
        var e = { 4567: function(e2, t2, i2) {
          ...
          const n = i2(9042), o2 = i2(6114), a = i2(9924), h2 = i2(844), c = i2(5596), l = i2(4725), d = i2(3656);
...
WARNING: This link could potentially be dangerous`)) {
          ...
          t2.Viewport = l = s2([r(2, c.IBufferService), r(3, c.IOptionsService), r(4, o2.ICharSizeService), r(5, o2.IRenderService), r(6, o2.ICoreBrowserService), r(7, o2.IThemeService)], l);
          ...
          const n = i2(5871), o2 = i2(3656), a = i2(4725), h2 = i2(844), c = i2(2585), l = { full: 0, left: 0, center: 0, right: 0 }, d = { full: 0, left: 0, center: 0, right: 0 }, _2 = { full: 0, left: 0, center: 0, right: 0 };
          ...
          t2.moveToCellSequence = function(e3, t3, i3, s3) {
            ...
            if (!i3.buffer.hasScrollback) return (function(e4, t4, i4, s4, o4, l2) {
              return 0 === r(t4, s4, o4, l2).length ? "" : c(a(e4, t4, e4, t4 - n(t4, o4), false, o4).length, h2("D", l2));
            })(o3, l, 0, t3, i3, s3) + r(l, t3, i3, s3) + (function(e4, t4, i4, s4, o4, l2) {
              let d2;
              d2 = r(t4, s4, o4, l2).length > 0 ? s4 - n(s4, o4) : t4;
              const _3 = s4, u = (function(e5, t5, i5, s5, o5, a2) {
                let h3;
                return h3 = r(i5, s5, o5, a2).length > 0 ? s5 - n(s5, o5) : t5, e5 < i5 && h3 <= s5 || e5 >= i5 && h3 < s5 ? "C" : "D";
              })(e4, t4, i4, s4, o4, l2);
              return c(a(e4, d2, i4, _3, "C" === u, o4).length, h2(u, l2));
            })(o3, l, e3, t3, i3, s3);
            let d;
            if (l === t3) return d = o3 > e3 ? "D" : "C", c(Math.abs(o3 - e3), h2(d, s3));
            d = l > t3 ? "D" : "C";
            const _2 = Math.abs(l - t3);
            return c((function(e4, t4) {
              return t4.cols - e4;
            })(l > t3 ? e3 : o3, i3) + (_2 - 1) * i3.cols + 1 + ((l > t3 ? o3 : e3) - 1), h2(d, s3));
          };
          ...
          const n = i2(3787), o2 = i2(2550), a = i2(2223), h2 = i2(6171), c = i2(4725), l = i2(8055), d = i2(8460), _2 = i2(844), u = i2(2585), f = "xterm-dom-renderer-owner-", v = "xterm-rows", p = "xterm-fg-", g = "xterm-bg-", m = "xterm-focus", S = "xterm-selection";
          let C = 1, b = t2.DomRenderer = class extends _2.Disposable {
            ...
            _setCellUnderline(e3, t3, i3, s3, r2, n2) {
              ...
              for (let o4 = i3; o4 <= s3; ++o4) {
                ...
                if (!f2 || !v2) break;
                f2.replaceChildren(...this._rowFactory.createRow(v2, u2, u2 === h3, d2, _3, c2, l2, this.dimensions.css.cell.width, this._widthCache, n2 ? o4 === i3 ? e3 : 0 : -1, n2 ? (o4 === s3 ? t3 : r2) - 1 : -1));
              }
            }
          };
          ...
          const n = i2(2223), o2 = i2(643), a = i2(511), h2 = i2(2585), c = i2(8055), l = i2(4725), d = i2(4269), _2 = i2(6171), u = i2(3734);
          let f = t2.DomRendererRowFactory = class {
            ...
            createRow(e3, t3, i3, s3, r2, a2, h3, l2, _3, f2, p) {
              ...
              for (let M = 0; M < b; M++) {
                ...
                if (" " === N && (I.isUnderline() || I.isOverline()) && (N = "\xA0"), A = b2 * l2 - _3.get(N, I.isBold(), I.isItalic()), C) {
                ...
                if (I.isBold() && B.push("xterm-bold"), I.isItalic() && B.push("xterm-italic"), I.isDim() && B.push("xterm-dim"), w = I.isInvisible() ? o2.WHITESPACE_CELL_CHAR : I.getChars() || o2.WHITESPACE_CELL_CHAR, I.isUnderline() && (B.push(`xterm-underline-${I.extended.underlineStyle}`), " " === w && (w = "\xA0"), !I.isUnderlineColorDefault())) if (I.isUnderlineColorRGB()) C.style.textDecorationColor = `rgb(${u.AttributeData.toColorRGB(I.getUnderlineColor()).join(",")})`;
                else {
          ...
          let u = t2.RenderService = class extends l.Disposable {
            ...
            constructor(e3, t3, i3, s3, r2, h3, _3, u2) {
              ...
              }))), this.register(i3.onMultipleOptionChange(["cursorBlink", "cursorStyle"], (() => this.refreshRows(h3.buffer.y, h3.buffer.y, true)))), this.register((0, n.addDisposableDomListener)(_3.window, "resize", (() => this.handleDevicePixelRatioChange()))), this.register(u2.onChangeColors((() => this._fullRefresh()))), "IntersectionObserver" in _3.window) {
          ...
          t2.RenderService = u = s2([r(2, _2.IOptionsService), r(3, h2.ICharSizeService), r(4, _2.IDecorationService), r(5, _2.IBufferService), r(6, h2.ICoreBrowserService), r(7, h2.IThemeService)], u);
          ...
          const n = i2(9806), o2 = i2(9504), a = i2(456), h2 = i2(4725), c = i2(8460), l = i2(844), d = i2(6114), _2 = i2(4841), u = i2(511), f = i2(2585), v = String.fromCharCode(160), p = new RegExp(v, "g");
          let g = t2.SelectionService = class extends l.Disposable {
            ...
            _selectWordAtCursor(e3, t3) {
              ...
              if (r2) return this._model.selectionStart = [r2.start.x - 1, r2.start.y - 1], this._model.selectionStartLength = (0, _2.getRangeLength)(r2, this._bufferService.cols), this._model.selectionEnd = void 0, true;
            ...
            _getWordAt(e3, t3, i3 = true, s3 = true) {
              ...
              h3++;
              let f2 = a2 + c2 - l2 + _3, v2 = Math.min(this._bufferService.cols, h3 - a2 + l2 + d2 - _3 - u2);
          ...
          const n = i2(7239), o2 = i2(8055), a = i2(8460), h2 = i2(844), c = i2(2585), l = o2.css.toColor("#ffffff"), d = o2.css.toColor("#000000"), _2 = o2.css.toColor("#ffffff"), u = o2.css.toColor("#000000"), f = { css: "rgba(255, 255, 255, 0.3)", rgba: 4294967117 };
          ...
          t2.NULL_COLOR = { css: "#00000000", rgba: 0 }, (function(e3) {
            ...
            function t3(e4, t4) {
              return a = Math.round(255 * t4), [r, n, o2] = _2.toChannels(e4.rgba), { css: h2.toCss(r, n, o2, a), rgba: h2.toRgba(r, n, o2, a) };
            }
            e3.blend = function(e4, t4) {
              if (a = (255 & t4.rgba) / 255, 1 === a) return { css: t4.css, rgba: t4.rgba };
              const i3 = t4.rgba >> 24 & 255, s3 = t4.rgba >> 16 & 255, c2 = t4.rgba >> 8 & 255, l2 = e4.rgba >> 24 & 255, d2 = e4.rgba >> 16 & 255, _3 = e4.rgba >> 8 & 255;
              return r = l2 + Math.round((i3 - l2) * a), n = d2 + Math.round((s3 - d2) * a), o2 = _3 + Math.round((c2 - _3) * a), { css: h2.toCss(r, n, o2), rgba: h2.toRgba(r, n, o2) };
              ...
              return [r, n, o2] = _2.toChannels(t4), { css: h2.toCss(r, n, o2), rgba: t4 };
            ...
            e3.toColor = function(e4) {
              if (e4.match(/#[\da-f]{3,8}/i)) switch (e4.length) {
                case 4:
                  return r = parseInt(e4.slice(1, 2).repeat(2), 16), n = parseInt(e4.slice(2, 3).repeat(2), 16), o2 = parseInt(e4.slice(3, 4).repeat(2), 16), _2.toColor(r, n, o2);
                case 5:
                  return r = parseInt(e4.slice(1, 2).repeat(2), 16), n = parseInt(e4.slice(2, 3).repeat(2), 16), o2 = parseInt(e4.slice(3, 4).repeat(2), 16), a = parseInt(e4.slice(4, 5).repeat(2), 16), _2.toColor(r, n, o2, a);
                case 7:
              ...
              if (s3) return r = parseInt(s3[1]), n = parseInt(s3[2]), o2 = parseInt(s3[3]), a = Math.round(255 * (void 0 === s3[5] ? 1 : parseFloat(s3[5]))), _2.toColor(r, n, o2, a);
          ...
          const s2 = i2(844), r = i2(2585), n = i2(4348), o2 = i2(7866), a = i2(744), h2 = i2(7302), c = i2(6975), l = i2(8460), d = i2(1753), _2 = i2(1480), u = i2(7994), f = i2(9282), v = i2(5435), p = i2(5981), g = i2(2660);
          let m = false;
          ...
          const n = i2(2584), o2 = i2(7116), a = i2(2015), h2 = i2(844), c = i2(482), l = i2(8437), d = i2(8460), _2 = i2(643), u = i2(511), f = i2(3734), v = i2(2585), p = i2(6242), g = i2(6351), m = i2(5941), S = { "(": 0, ")": 1, "*": 2, "+": 3, "-": 1, ".": 2 }, C = 131072;
          function b(e3, t3) {
          ...
          class E extends h2.Disposable {
            ...
            constructor(e3, t3, i3, s3, r2, h3, _3, f2, v2 = new a.EscapeSequenceParser()) {
            ...
            print(e3, t3, i3) {
              let s3, r2;
              const n2 = this._charsetService.charset, o3 = this._optionsService.rawOptions.screenReaderMode, a2 = this._bufferService.cols, h3 = this._coreService.decPrivateModes.wraparound, l2 = this._coreService.modes.insertMode, d2 = this._curAttrData;
            ...
            requestMode(e3, t3) {
              const i3 = this._coreService.decPrivateModes, { activeProtocol: s3, activeEncoding: r2 } = this._coreMouseService, o3 = this._coreService, { buffers: a2, cols: h3 } = this._bufferService, { active: c2, alt: l2 } = a2, d2 = this._optionsService.rawOptions, _3 = (e4) => e4 ? 1 : 2, u2 = e3.params[0];
              return f2 = u2, v2 = t3 ? 2 === u2 ? 4 : 4 === u2 ? _3(o3.modes.insertMode) : 12 === u2 ? 3 : 20 === u2 ? _3(d2.convertEol) : 0 : 1 === u2 ? _3(i3.applicationCursorKeys) : 3 === u2 ? d2.windowOptions.setWinLines ? 80 === h3 ? 2 : 132 === h3 ? 1 : 0 : 0 : 6 === u2 ? _3(i3.origin) : 7 === u2 ? _3(i3.wraparound) : 8 === u2 ? 3 : 9 === u2 ? _3("X10" === s3) : 12 === u2 ? _3(d2.cursorBlink) : 25 === u2 ? _3(!o3.isCursorHidden) : 45 === u2 ? _3(i3.reverseWraparound) : 66 === u2 ? _3(i3.applicationKeypad) : 67 === u2 ? 4 : 1e3 === u2 ? _3("VT200" === s3) : 1002 === u2 ? _3("DRAG" === s3) : 1003 === u2 ? _3("ANY" === s3) : 1004 === u2 ? _3(i3.sendFocus) : 1005 === u2 ? 4 : 1006 === u2 ? _3("SGR" === r2) : 1015 === u2 ? 4 : 1016 === u2 ? _3("SGR_PIXELS" === r2) : 1048 === u2 ? 1 : 47 === u2 || 1047 === u2 || 1049 === u2 ? _3(c2 === l2) : 2004 === u2 ? _3(i3.bracketedPasteMode) : 0, o3.triggerDataEvent(`${n.C0.ESC}[${t3 ? "" : "?"}${f2};${v2}$y`), true;
              var f2, v2;
            }
          ...
          const s2 = i2(6349), r = i2(7226), n = i2(3734), o2 = i2(8437), a = i2(4634), h2 = i2(511), c = i2(643), l = i2(4863), d = i2(7116);
          ...
          Object.defineProperty(t2, "__esModule", { value: true }), t2.getWrappedLineTrimmedLength = t2.reflowSmallerGetNewLineLengths = t2.reflowLargerApplyNewLayout = t2.reflowLargerCreateNewLayout = t2.reflowLargerGetLinesToRemove = void 0, t2.reflowLargerGetLinesToRemove = function(e3, t3, s2, r, n) {
            ...
            for (let a = 0; a < e3.length - 1; a++) {
              ...
              for (; u < l.length; ) {
                const e4 = i2(l, u, t3), r2 = e4 - f, o3 = s2 - _2, a2 = Math.min(r2, o3);
          ...
          Object.defineProperty(t2, "__esModule", { value: true }), t2.Utf8ToUtf32 = t2.StringToUtf32 = t2.utf32ToString = t2.stringFromCodePoint = void 0, t2.stringFromCodePoint = function(e3) {
            ...
            decode(e3, t3) {
              ...
              if (this.interim[0]) {
                ...
                const h3 = 192 == (224 & this.interim[0]) ? 2 : 224 == (240 & this.interim[0]) ? 3 : 4, l2 = h3 - o3;
                for (; c < l2; ) {
                  if (c >= i2) return 0;
              ...
              let d = c;
              for (; d < i2; ) {
                for (; !(!(d < l) || 128 & (s2 = e3[d]) || 128 & (r = e3[d + 1]) || 128 & (n = e3[d + 2]) || 128 & (o2 = e3[d + 3])); ) t3[a++] = s2, t3[a++] = r, t3[a++] = n, t3[a++] = o2, d += 4;
          ...
          const n = i2(1439), o2 = i2(8460), a = i2(844), h2 = i2(2585), c = Object.freeze({ insertMode: false }), l = Object.freeze({ applicationCursorKeys: false, applicationKeypad: false, bracketedPasteMode: false, origin: false, reverseWraparound: false, sendFocus: false, wraparound: true });
        ...
        return (() => {
          ...
          const t2 = i(9042), r = i(3236), n = i(844), o2 = i(5741), a = i(8285), h2 = i(7975), c = i(7090), l = ["cols", "rows"];
  ...
  // ../../../../frontend/node_modules/@xterm/addon-fit/lib/addon-fit.mjs
  var h = 2;
  var _ = 1;
  var o = class {
    activate(e) {
