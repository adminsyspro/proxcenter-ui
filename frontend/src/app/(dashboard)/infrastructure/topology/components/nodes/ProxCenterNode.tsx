  ...
  return (
    <Box
      sx={{
        ...
        alignItems: 'center',
        gap: 1.5,
        boxShadow: `0 4px 16px rgba(242, 146, 33, 0.2)`,
        cursor: 'pointer',
        '&:hover': {
          boxShadow: `0 6px 24px rgba(242, 146, 33, 0.3)`,
        },
      }}
    >
      ...
      <Handle type='source' position={Position.Bottom} style={{ background: primaryColor }} />
    </Box>
  )
}
