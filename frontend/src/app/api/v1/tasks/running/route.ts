...
function formatTaskType(type: string): string {
  const types: Record<string, string> = {
    ...
    'vzclone': 'Clone LXC',
    'vzsnapshot': 'Snapshot LXC',
    'vzrollback': 'Rollback LXC',
    'vzdump': 'Backup',
    'qmbackup': 'Backup VM',
    'vzbackup': 'Backup LXC',
    'vncproxy': 'VNC Console',
    'spiceproxy': 'SPICE Console',
    // Shell sessions. PVE keeps these tasks running for the whole life of the
    // console, so they are the ones an operator actually sees piling up in the
    // dropdown and in the tab title — and the ones whose raw type showed
    // through ("vncshell") for want of an entry here.
    'vncshell': 'Shell Console',
    'spiceshell': 'SPICE Shell',
    'termproxy': 'Shell Console',
    'startall': 'Start All',
    'stopall': 'Stop All',
