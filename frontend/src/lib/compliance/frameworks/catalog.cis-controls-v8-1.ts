// Authored from the CIS Controls v8.1 safeguard set: identifiers and short titles
// only. CIS descriptive text is copyright Center for Internet Security and is NOT
// reproduced here.
