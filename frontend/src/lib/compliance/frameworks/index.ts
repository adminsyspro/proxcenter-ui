...
export const FRAMEWORKS: FrameworkDef[] = [
  { id: 'nist-800-53-r5', name: 'NIST SP 800-53', version: 'Rev 5', sourceUrl: 'https://csrc.nist.gov/pubs/sp/800/53/r5/upd1/final', baselineLabel: 'Moderate baseline', controls: NIST_800_53_R5_CONTROLS },
  { id: 'nist-800-171-r2', name: 'NIST SP 800-171', version: 'Rev 2', sourceUrl: 'https://csrc.nist.gov/pubs/sp/800/171/r2/upd1/final', provenanceNote: REV2_NOTE, controls: NIST_800_171_R2_CONTROLS },
  { id: 'cmmc-l2', name: 'CMMC', version: 'Level 2', sourceUrl: 'https://dodcio.defense.gov/CMMC/', provenanceNote: REV2_NOTE, controls: CMMC_L2_CONTROLS },
]
